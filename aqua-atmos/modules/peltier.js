...
export function buildPeltier() {
  ...
  annotate(
    g,
    new THREE.Vector3(-HW + T, tecY, -HD * 0.42),
    new THREE.Vector3(-HW - 16, tecY + 8, -HD - 4),
    1,
    "#4ab8e8",
  );
  ...
  annotate(
    g,
    new THREE.Vector3(-HW + T / 2, tecY + tecSz / 2 + 1, HD * 0.42),
    new THREE.Vector3(-HW - 16, tecY + 14, HD + 6),
    2,
    "#2a6090",
  );
  ...
  annotate(
    g,
    new THREE.Vector3(-HW + T + 0.7, tecY + tecSz / 2, 0),
    new THREE.Vector3(-HW - 16, tecY + tecSz / 2 + 5, 5),
    3,
    "#7a6548",
  );
  ...
  annotate(
    g,
    new THREE.Vector3(-(HW + 0.5 + finLen * 0.5), finBaseY + finLen * 0.5, 0),
    new THREE.Vector3(
      -(HW + 0.5 + finLen + 12),
      finBaseY + finLen * 0.5 + 5,
      0,
    ),
    4,
    "#8aaabb",
  ...
  // ⑤ Ventilateur intérieur (pales courbées)
  annotate(
    g,
    new THREE.Vector3(-ifX, ifY + ifR, 0),
    new THREE.Vector3(-ifX - 13, ifY + ifR + 10, 7),
    5,
    "#5590cc",
  );
  ...
  annotate(
    g,
    new THREE.Vector3(8, gutY, -HD + 4),
    new THREE.Vector3(18, gutY + 9, -HD - 7),
    6,
    "#1f8ec2",
  );
